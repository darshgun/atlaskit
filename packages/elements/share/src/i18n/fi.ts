...
export default {
  ...
  'fabric.elements.share.success.message':
    '{object, select, blogpost {Blog post shared} taulu {Board shared} kalenteri {Calendar shared} luonnos {Draft shared} suodatin {Filter shared} asia {Issue shared} media {Media shared} sivu {Page shared} projekti {Project shared} pull-pyyntö {Pull Request shared} kysymys {Question shared} raportti {Report shared} säilö {Repository shared} pyyntö {Request shared} etenemissuunnitelma {Roadmap shared} sivusto {Site shared} työtila {Space shared} muu {Link Shared}}',
