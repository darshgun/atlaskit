...
export default {
  ...
  'fabric.elements.share.success.message':
    '{object, select, blogpost {Blog post shared}tavle {Board shared}kalender {Calendar shared}kladde {Draft shared} filter {Filter shared} sag {Issue shared} medie {Media shared} side {Page shared} projekt {Project shared} trækanmodning {Pull Request shared} spørgsmål {Question shared} rapport {Report shared} lager {Repository shared} anmodning {Request shared} oversigt {Roadmap shared} site {Site shared} område {Space shared} andet {Link Shared}}',
