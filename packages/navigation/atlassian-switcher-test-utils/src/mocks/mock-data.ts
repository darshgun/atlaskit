    ...
    sites: [
      {
        ...
        availableProducts: [
          {
            activityCount: 0,
            productType: ProductType.CONFLUENCE,
          },
          {
            activityCount: 0,
            productType: ProductType.JIRA_SOFTWARE,
          },
        ],
      ...
      },
      {
        ...
        availableProducts: [
          ...
          {
            activityCount: 0,
            productType: ProductType.JIRA_BUSINESS,
          },
        ],
      ...
      },
      {
        ...
        availableProducts: [
          ...
          {
            activityCount: 0,
            productType: ProductType.JIRA_SERVICE_DESK,
          },
          {
            activityCount: 200,
            productType: ProductType.JIRA_SOFTWARE,
      ...
      },
      {
        ...
        availableProducts: [
          ...
          },
          {
            ...
            productType: ProductType.OPSGENIE,
      ...
      },
      {
        ...
        availableProducts: [
          {
            activityCount: 0,
            productType: ProductType.BITBUCKET,
      ...
      },
      {
        ...
        availableProducts: [
          {
            activityCount: 25,
            productType: ProductType.STATUSPAGE,
