import {
  ...
  WorklensProductType,
} from '@atlaskit/atlassian-switcher/types';
...
export interface MockData {
  AVAILABLE_PRODUCTS_DATA: AvailableProductsResponse;
    ...
    sites: [
      {
        ...
        availableProducts: [
          {
            activityCount: 0,
            productType: WorklensProductType.CONFLUENCE,
          },
          {
            activityCount: 0,
            productType: WorklensProductType.JIRA_SOFTWARE,
          },
        ],
      ...
      },
      {
        ...
        availableProducts: [
          ...
          {
            activityCount: 0,
            productType: WorklensProductType.JIRA_SERVICE_DESK,
          },
          {
            activityCount: 200,
            productType: WorklensProductType.JIRA_SOFTWARE,
      ...
      },
      {
        ...
        availableProducts: [
          ...
          {
            activityCount: 30, // This will be 0 in practice. Just setting it to show up in the example.
            productType: WorklensProductType.OPSGENIE,
      ...
      },
      {
        ...
        availableProducts: [
          {
            activityCount: 0,
            productType: WorklensProductType.BITBUCKET,
      ...
      },
      {
        ...
        availableProducts: [
          {
            activityCount: 25,
            productType: WorklensProductType.STATUSPAGE,
