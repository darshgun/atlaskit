...
describe('matchRoute', () => {
  describe('pathname', () => {
    it('should match a pathname without a query string', () => {
      const route = { path: '/foo/:bar', component: Noop, navigation: null };
      // @ts-ignore
    ...
    it('should return the first route that is a match', () => {
      const routeA = { path: '/foo/:bar', component: Noop, navigation: null };
      const routeB = { path: '/foo/:baz', component: Noop, navigation: null };
      expect(
        // @ts-ignore
