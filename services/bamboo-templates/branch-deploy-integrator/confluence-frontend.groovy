plan(key:'ABDICC',name:'confluence-frontend Atlaskit Branch Deploy Integrator',
    ...
    enabled:'false') {
    createBranchDeployIntegrator(sourceRepo: 'Atlaskit-MK-2', productRepo: 'confluence-frontend', productCiPlanUrl: 'https://confluence-cloud-bamboo.internal.atlassian.com/rest/api/latest/plan/CONFMICRO-CFCPB')
    branchMonitoring() {
